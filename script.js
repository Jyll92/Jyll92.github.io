...
function LoadProjects() {
    ...
    // Footer.style.top = "2vh";
    mainWindow.style.opacity = "0";
    mainWindow.style.filter = "blur(14px)"
    setTimeout(() => {
    ...
    setTimeout(() => {
        projectOne.style.transition = `all .1s cubic-bezier(0.165, 0.84, 0.44, 1)`;
        projectTwo.style.transition = `all .1s cubic-bezier(0.165, 0.84, 0.44, 1)`;
        projectThree.style.transition = `all .1s cubic-bezier(0.165, 0.84, 0.44, 1)`;
    }, 1000)
    setTimeout(() => {
